...
public class Books {
    ...
    public void searchBySno()
    {
        ...
        sNo = input.nextInt();
        int flag = 0;
        System.out.println("S.No\t\tName\t\tAuthor\t\tCategory\t\tAvailable Qty\t\tTotal Qty");
        for (int i = 0; i < count; i++) {
    ...
    public void searchByCategoryName()
    {
        ...
        int flag = 0;
        System.out.println("S.No\t\tName\t\tAuthor\t\tCategory\t\tCategory\t\tAvailable Qty\t\tTotal Qty");
        for (int i = 0; i < count; i++) {
            if (categoryName.equalsIgnoreCase(theBooks[i].categoryName)) {
                System.out.println(
                        theBooks[i].sNo + "\t\t\t"
                                + theBooks[i].bookName + "\t\t\t"
                                + theBooks[i].authorName + "\t\t\t"
        ...
        if (flag == 0)
            System.out.println("No Books of " + categoryName + " Found.");
    }
